...
public class LiferayDBMigratorUtil {
     ...
     */
    public static void disableForeignKeys(Connection pgConn) throws SQLException {
     ...
     */
    public static void enableForeignKeys(Connection pgConn) throws SQLException {
        try (Statement stmt = pgConn.createStatement()) {
     ...
     */
    public static List<String> getTables(Connection myConn) throws SQLException {
     ...
     */
    public static boolean truncateTable(Connection pgConn, String tableName) {
     ...
     */
    public static void migrateTableData(Connection myConn, Connection pgConn, String tableName, int batchSize) throws SQLException {
        String pgTable = tableName.toLowerCase();
    ...
    public static LiferayDBMigratorConfig loadConfiguration(String[] args) {
        ...
        // 4. Retornar la nueva instancia del Record
